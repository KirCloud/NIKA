    ...
    constexpr long OFFSET_IN_FORWARD = 0x073cc470;                       //[Buttons]->in_forward
    ...
    constexpr long OFF_VIEW_RENDER = 0x73cb268;                   //[RecvTable.DT_Player]->ViewRender
    ...
    constexpr long OFF_NAMELIST = 0xc450df0;                      //[Miscellaneous]->NameList
    ...
    constexpr long OFF_PROJECTILESCALE = 0x1e64;                  //projectile_gravity_scale + BASE
    constexpr long OFF_PROJECTILESPEED = 0x1e5c;                  //projectile_launch_speed + BASE
    //glow
